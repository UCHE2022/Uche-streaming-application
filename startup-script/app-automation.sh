...
sudo wget https://raw.githubusercontent.com/UCHE2022/Uche-streaming-application/main/apache-config/000-default.conf -P /etc/apache2/sites-enabled/
...
sudo wget https://raw.githubusercontent.com/UCHE2022/Uche-streaming-application/main/database-config/wp-config.php -P /var/www/wordpress/
